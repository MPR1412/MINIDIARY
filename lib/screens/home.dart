...
import 'package:minidiary/components/faderoute.dart';
import 'package:minidiary/data/models.dart';
import 'package:minidiary/screens/edit.dart';
import 'package:minidiary/screens/view.dart';
import 'package:minidiary/services/database.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text('Write Diary'.toUpperCase()),
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Icon(
                isFlagOn ? Icons.turned_in : OMIcons.turnedIn,
